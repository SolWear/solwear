...
import com.solwear.mobile.ui.screens.SettingsScreen
import com.solwear.mobile.ui.theme.SolWearTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SolWearTheme {
                SolWearNavGraph(viewModel = viewModel)
            }
        }
...
@Composable
fun SolWearNavGraph(viewModel: WalletViewModel) {
